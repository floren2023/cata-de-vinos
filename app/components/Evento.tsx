  ...
  return (
    ...
    <Card className="w-[350px] h-[480px] text-md bg-white">
      <CardHeader>
        ...
        <button type="button">
        <FaRegHeart className="text-red-800 w-6 h-6" /></button>
        </div>
      ...
      <CardContent>
        ...
        <div className="flex flex-col  justify-end mt-4">
          ...
          <button className="inline-flex h-10 items-center justify-center rounded-md
           bg-red-800 merienda-h3  px-5 font-medium text-neutral-50 transition active:scale-110 active:ring-red-600 active:ring-4 hover:ring-red-600"  onClick={() => setOpenModal(true)}>
   ...
   >
     ...
     <Modal.Footer>
       <button onClick={() => setOpenModal(false)} className="p-2 rounded-md text-red-800 border-2 border-red-800 ">Apuntarme</button>
       <button color="gray" className="text-gray-400 border-2 border-gray-400 rounded-md p-2 ml-4" onClick={() => setOpenModal(false)}>
         Cancelar
       </button>
     </Modal.Footer>
   </Modal>
